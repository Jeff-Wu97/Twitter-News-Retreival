...
var
	searchForm = document.getElementById('search_form'), // get "form" element (to change value of "action" attribute)
	inputSubmit = document.getElementById('search_input'), // get "input" element (to change "name" attribute)
	mainColor = document.getElementById("body"), // get main background color
	logoImage = document.getElementById("search_blank"), // get logo image
